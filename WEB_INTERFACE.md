...
1. **Число кубитов**: Ограничено 2 (для производительности)
2. **Максимальные shots**: 100,000 (для разумного времени выполнения)
3. **Экспорт данных**: Пока не реализован (планируется в следующей версии)
4. **3-кубитные системы**: Не поддерживаются (требуют существенно больше ресурсов)
